...
LOGGER = logging.getLogger("samples.franklin_county_ollama.client")
FRANKLIN_TOOL_NAME = "franklin_county_auditor_search"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Ask Ollama a natural Franklin County auditor question and log whether "
...
def main() -> None:
    ...
    final_text = asyncio.run(
        run_tool_trigger_sample(
            ...
            logger=LOGGER,
            server_params_factory=franklin_server_params,
        )
    )
    print(final_text)
