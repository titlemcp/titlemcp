    ...
    *,
    ...
    return {
        ...
        "capability_convention": {
            ...
            "template": "jurisdictions/_templates/capability_package",
            "notes": (
                "Add jurisdiction-specific adapters, tools, workflows, schemas, or tests here. "
                "Keep shared logic in src/title_mcp and call it from jurisdiction code."
            ),
        },
    }
...
def write_root_files(root: Path) -> None:
    ...
    write_json(
        ...
        placeholder_payload(
            ...
            relative_path=Path("jurisdictions/US"),
        ),
    )
...
def main() -> None:
    ...
    parser.add_argument("--root", default="jurisdictions", help="Output directory")
